...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTitle.is_published'
        db.add_column('multilingual_events_eventtitle', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTitle.is_published'
        db.delete_column('multilingual_events_eventtitle', 'is_published')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
