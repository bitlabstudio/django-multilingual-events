...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventAgendaSession.content'
        db.delete_column('cmsplugin_eventagendasession', 'content_id')

        # Adding field 'EventAgendaSession.description'
        db.add_column('cmsplugin_eventagendasession', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=4000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventAgendaSession.content'
        db.add_column('cmsplugin_eventagendasession', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EventAgendaSession.description'
        db.delete_column('cmsplugin_eventagendasession', 'description')
