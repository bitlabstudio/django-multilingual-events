...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTitle.meta_description'
        db.add_column('multilingual_events_eventtitle', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTitle.meta_description'
        db.delete_column('multilingual_events_eventtitle', 'meta_description')
