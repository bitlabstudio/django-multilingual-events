...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAgendaSession'
        db.create_table('cmsplugin_eventagendasession', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('multilingual_events', ['EventAgendaSession'])

        # Adding model 'EventAgendaDay'
        db.create_table('cmsplugin_eventagendaday', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('multilingual_events', ['EventAgendaDay'])


    def backwards(self, orm):
        # Deleting model 'EventAgendaSession'
        db.delete_table('cmsplugin_eventagendasession')

        # Deleting model 'EventAgendaDay'
        db.delete_table('cmsplugin_eventagendaday')
