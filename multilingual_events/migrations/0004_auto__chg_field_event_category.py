...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('multilingual_events_event', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['multilingual_events.EventCategory']))

    def backwards(self, orm):

        # Changing field 'Event.category'
        db.alter_column('multilingual_events_event', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multilingual_events.EventCategory'], null=True))
