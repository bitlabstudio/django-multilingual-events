...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('multilingual_events_event', 'venue_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Event.venue_url_name'
        db.add_column('multilingual_events_event', 'venue_url_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Event.google_maps_shortlink'
        db.add_column('multilingual_events_event', 'google_maps_shortlink',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Event.google_maps_embed_code'
        db.add_column('multilingual_events_event', 'google_maps_embed_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.venue_url'
        db.delete_column('multilingual_events_event', 'venue_url')

        # Deleting field 'Event.venue_url_name'
        db.delete_column('multilingual_events_event', 'venue_url_name')

        # Deleting field 'Event.google_maps_shortlink'
        db.delete_column('multilingual_events_event', 'google_maps_shortlink')

        # Deleting field 'Event.google_maps_embed_code'
        db.delete_column('multilingual_events_event', 'google_maps_embed_code')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'multilingual_events.event': {
            ...
            'google_maps_embed_code': ('django.db.models.fields.CharField', [], {'max_length': '4000', 'blank': 'True'}),
            'google_maps_shortlink': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'venue_url_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'})
        },
