...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAgendaTalk'
        db.create_table('cmsplugin_eventagendatalk', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=4000, blank=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document_library.Document'], null=True, blank=True)),
        ))
        db.send_create_signal('multilingual_events', ['EventAgendaTalk'])


    def backwards(self, orm):
        # Deleting model 'EventAgendaTalk'
        db.delete_table('cmsplugin_eventagendatalk')
