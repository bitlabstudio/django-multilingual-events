...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.url_name'
        db.add_column('multilingual_events_event', 'url_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.url_name'
        db.delete_column('multilingual_events_event', 'url_name')
