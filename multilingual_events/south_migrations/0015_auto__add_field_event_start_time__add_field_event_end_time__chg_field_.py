...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('multilingual_events_event', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column('multilingual_events_event', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event.end_date'
        db.alter_column('multilingual_events_event', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.start_date'
        db.alter_column('multilingual_events_event', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Event.start_time'
        db.delete_column('multilingual_events_event', 'start_time')

        # Deleting field 'Event.end_time'
        db.delete_column('multilingual_events_event', 'end_time')


        # Changing field 'Event.end_date'
        db.alter_column('multilingual_events_event', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.start_date'
        db.alter_column('multilingual_events_event', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
