...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventTitle.address'
        db.delete_column('multilingual_events_eventtitle', 'address')

        # Adding field 'EventTitle.city'
        db.add_column('multilingual_events_eventtitle', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'EventTitle.postal_code'
        db.add_column('multilingual_events_eventtitle', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'EventTitle.address_1'
        db.add_column('multilingual_events_eventtitle', 'address_1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'EventTitle.address_2'
        db.add_column('multilingual_events_eventtitle', 'address_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventTitle.address'
        db.add_column('multilingual_events_eventtitle', 'address',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2000, blank=True),
                      keep_default=False)

        # Deleting field 'EventTitle.city'
        db.delete_column('multilingual_events_eventtitle', 'city')

        # Deleting field 'EventTitle.postal_code'
        db.delete_column('multilingual_events_eventtitle', 'postal_code')

        # Deleting field 'EventTitle.address_1'
        db.delete_column('multilingual_events_eventtitle', 'address_1')

        # Deleting field 'EventTitle.address_2'
        db.delete_column('multilingual_events_eventtitle', 'address_2')
