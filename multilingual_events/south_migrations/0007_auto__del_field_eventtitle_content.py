...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventTitle.content'
        db.delete_column('multilingual_events_eventtitle', 'content_id')


    def backwards(self, orm):
        # Adding field 'EventTitle.content'
        db.add_column('multilingual_events_eventtitle', 'content',
