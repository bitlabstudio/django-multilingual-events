...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('multilingual_events_event', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multilingual_events.EventCategory'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.category'
        db.delete_column('multilingual_events_event', 'category_id')
    ...
    models = {
        ...
        'multilingual_events.event': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multilingual_events.EventCategory']", 'null': 'True'}),
