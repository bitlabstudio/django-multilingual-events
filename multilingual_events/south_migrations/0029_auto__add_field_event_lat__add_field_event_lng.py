...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('multilingual_events_event', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.lng'
        db.add_column('multilingual_events_event', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('multilingual_events_event', 'lat')

        # Deleting field 'Event.lng'
        db.delete_column('multilingual_events_event', 'lng')
