...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('multilingual_events_eventcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('multilingual_events', ['EventCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('multilingual_events_eventcategory')
