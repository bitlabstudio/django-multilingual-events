...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('multilingual_events_event', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=65, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.timezone'
        db.delete_column('multilingual_events_event', 'timezone')
