...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventAgendaSession.document'
        db.add_column('cmsplugin_eventagendasession', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document_library.Document'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventAgendaSession.document'
        db.delete_column('cmsplugin_eventagendasession', 'document_id')
