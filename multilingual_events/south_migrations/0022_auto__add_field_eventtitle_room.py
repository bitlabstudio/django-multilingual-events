...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTitle.room'
        db.add_column('multilingual_events_eventtitle', 'room',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTitle.room'
        db.delete_column('multilingual_events_eventtitle', 'room')
